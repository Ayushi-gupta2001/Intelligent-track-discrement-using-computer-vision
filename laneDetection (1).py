...
################################################################################
# BY:           Akash Anand | Ayushi Gupta | Rahul Gupta 
################################################################################
...
def readVideo():
    ...
    inpImage = cv2.VideoCapture(os.path.join(CWD_PATH, 'testvideo2.mp4'))
...
def addText(img, radius, direction, deviation, devDirection):
    ...
    if (direction != 'Straight'):
        ...
        text1 = 'Direction of curve : ' + (direction)
    ...
    cv2.putText(img,"Akash Anand | Ayushi Gupta | Rahul Gupta", (20,700),cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8,(0,200,200))
    return img
